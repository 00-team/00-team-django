...
class UserAccount(models.Model):
    ...
    def get_picture(self, url: str):
        ...
        self.picture.save(
            f'pp-{self.user.username}-{self.id}-{self.nickname}.png', File(tf))
        self.save()
...
class UserTemp(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        super(UserTemp, self).save(*args, **kwargs)
